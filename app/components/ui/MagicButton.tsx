...
const MagicButton = ({
  ...
  return (
    <button onClick={handleClick} className={`inline-flex h-12 overflow-hidden p-[2px] dark:p-[1px] focus:outline-none md:w-auto md:mt-10 ${optionalClasses}`}>
      <span className="absolute inset-[-1000%] animate-[spin_2s_linear_infinite] dark:bg-[conic-gradient(from_90deg_at_50%_50%,#E2CBFF_0%,#393BB2_50%,#E2CBFF_100%)] bg-[conic-gradient(from_90deg_at_50%_50%,#3B82F6_0%,#E2CBFF_50%,#3B82F6_100%)]" />
